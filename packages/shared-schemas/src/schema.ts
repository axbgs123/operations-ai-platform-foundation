...
export interface paths {
    ...
    "/v1/extension/session/challenge": {
        ...
        get?: never;
        put?: never;
        /** Create Extension Session Challenge */
        post: operations["create_extension_session_challenge_v1_extension_session_challenge_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/extension/session/renew": {
        ...
        get?: never;
        put?: never;
        /** Renew Extension Session */
        post: operations["renew_extension_session_v1_extension_session_renew_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspace_id}/agent/chats": {
        ...
        /** List Chats */
        get: operations["list_chats_v1_workspaces__workspace_id__agent_chats_get"];
        put?: never;
        /** Create Chat */
        post: operations["create_chat_v1_workspaces__workspace_id__agent_chats_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspace_id}/agent/chats/{chat_id}": {
        ...
        /** Read Chat */
        get: operations["read_chat_v1_workspaces__workspace_id__agent_chats__chat_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/workspaces/{workspace_id}/agent/chats/{chat_id}/archive": {
        ...
        put?: never;
        /** Archive Chat */
        post: operations["archive_chat_v1_workspaces__workspace_id__agent_chats__chat_id__archive_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspace_id}/agent/chats/{chat_id}/messages": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Append Chat Message */
        post: operations["append_chat_message_v1_workspaces__workspace_id__agent_chats__chat_id__messages_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspace_id}/agent/chats/{chat_id}/turns": {
        ...
        put?: never;
        /** Send Chat Turn */
        post: operations["send_chat_turn_v1_workspaces__workspace_id__agent_chats__chat_id__turns_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspace_id}/extension-devices": {
        ...
        get: operations["list_extension_devices_v1_workspaces__workspace_id__extension_devices_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/workspaces/{workspace_id}/extension-devices/{device_id}": {
        ...
        put?: never;
        post?: never;
        /** Revoke Extension Device */
        delete: operations["revoke_extension_device_v1_workspaces__workspace_id__extension_devices__device_id__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/v1/workspaces/{workspace_id}/public-data/contents/{content_id}/binding": {
        ...
        /** Read Binding */
        get: operations["read_binding_v1_workspaces__workspace_id__public_data_contents__content_id__binding_get"];
        /** Bind Content */
        put: operations["bind_content_v1_workspaces__workspace_id__public_data_contents__content_id__binding_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/v1/workspaces/{workspace_id}/public-data/contents/{content_id}/collect-now": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /** Collect Now */
        post: operations["collect_now_v1_workspaces__workspace_id__public_data_contents__content_id__collect_now_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/workspaces/{workspace_id}/public-data/provider": {
        ...
        /** Read Provider */
        get: operations["read_provider_v1_workspaces__workspace_id__public_data_provider_get"];
        /** Save Provider */
        put: operations["save_provider_v1_workspaces__workspace_id__public_data_provider_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/v1/workspaces/{workspace_id}/public-data/provider/test": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        AgentChatListRead: {
            /** Items */
            items: components["schemas"]["AgentChatSummaryRead"][];
            /** Page */
            page: number;
            /** Page Size */
            page_size: number;
        ...
        AgentChatMessageRead: {
             ...
             * @enum {string}
             */
            kind: "text" | "plan" | "run" | "confirmation" | "artifact" | "safe_error";
            /** Plan Id */
            plan_id: string | null;
            /**
             * Role
        ...
        CollectionJobRead: {
             ...
             * @enum {string}
             */
            status: "scheduled" | "running" | "retrying" | "succeeded" | "failed" | "cancelled";
            /** Target Window */
        ...
        ContentBindingRead: {
            ...
            id: string;
            /** Jobs */
            jobs: components["schemas"]["CollectionJobRead"][];
            /** Last Verified At */
        ...
        /** ExtensionSessionChallengeRequest */
        ExtensionSessionChallengeRequest: {
            /**
             * Client Id
             * @constant
        ...
        SnapshotCreate: {
             ...
             * @enum {string}
             */
            source: "manual" | "tabular_import" | "screenshot" | "extension" | "public_api";
        };
        /** SnapshotMetricInput */
        SnapshotMetricInput: {
            /** Key */
...
export interface operations {
    ...
    create_extension_session_challenge_v1_extension_session_challenge_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ExtensionSessionChallengeRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    renew_extension_session_v1_extension_session_renew_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ExtensionSessionRenewRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    list_chats_v1_workspaces__workspace_id__agent_chats_get: {
        parameters: {
            query?: {
                page?: number;
                page_size?: number;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AgentChatListRead"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    create_chat_v1_workspaces__workspace_id__agent_chats_post: {
        parameters: {
            query?: never;
            header: {
                "Idempotency-Key": string;
        ...
        responses: {
            ...
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["AgentChatSummaryRead"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    read_chat_v1_workspaces__workspace_id__agent_chats__chat_id__get: {
        parameters: {
            query?: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AgentChatRead"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    archive_chat_v1_workspaces__workspace_id__agent_chats__chat_id__archive_post: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
    ...
    append_chat_message_v1_workspaces__workspace_id__agent_chats__chat_id__messages_post: {
        parameters: {
            query?: never;
            header: {
                "Idempotency-Key": string;
    ...
    send_chat_turn_v1_workspaces__workspace_id__agent_chats__chat_id__turns_post: {
        parameters: {
            query?: never;
            header: {
                "Idempotency-Key": string;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["AgentChatTurnCreate"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    revoke_extension_device_v1_workspaces__workspace_id__extension_devices__device_id__delete: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
    ...
    read_binding_v1_workspaces__workspace_id__public_data_contents__content_id__binding_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ContentBindingRead"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    bind_content_v1_workspaces__workspace_id__public_data_contents__content_id__binding_put: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ContentBindingInput"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    collect_now_v1_workspaces__workspace_id__public_data_contents__content_id__collect_now_post: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
    ...
    read_provider_v1_workspaces__workspace_id__public_data_provider_get: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ProviderConfigRead"] | null;
                };
            };
            /** @description Validation Error */
            422: {
    ...
    save_provider_v1_workspaces__workspace_id__public_data_provider_put: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
    ...
    test_provider_v1_workspaces__workspace_id__public_data_provider_test_post: {
        parameters: {
            query?: never;
            header?: {
                "X-CSRF-Token"?: string | null;
