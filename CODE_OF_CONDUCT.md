...
private reporting contact described in [SECURITY.md](SECURITY.md). Do not put
sensitive incident details in a public issue. All community leaders are
...
1. **Correction.** A private, written warning that the behavior was
   inappropriate, with clarity around the violated rule and an explanation of
...
3. **Temporary Ban.** A temporary ban from any sort of interaction or public
   ...
   interaction with those enforcing the Code of Conduct, is permitted during
